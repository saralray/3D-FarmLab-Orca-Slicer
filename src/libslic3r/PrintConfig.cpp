...
void PrintConfigDef::init_fff_params()
{
    ...
    */
    ...
    // Snapmaker "Full Spectrum" mixed-filament / dithering settings.
    // All options default to "off/neutral" so existing presets and projects
    // slice identically when the Mixed Filaments feature is unused.
...
//    def->min = 0;
    ...
    // Snapmaker "Full Spectrum" Local-Z wipe tower tuning.
